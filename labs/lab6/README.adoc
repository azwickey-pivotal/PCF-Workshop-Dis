...
+
image:../../fortune-teller/docs/images/fortunes_1.png[]
...
+
image:../../fortune-teller/docs/images/fortunes_2.png[]

. Access the fortunes-ui and show that the circuit breaker is registering successful requests.
+
image:../../fortune-teller/docs/images/fortunes_3.png[]
